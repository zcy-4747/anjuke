...
# # 激活Mongodb
woaiwojia_n = client['woaiwojia_n']
# # 给数据库命名
woaiwojia_Dates_newData = woaiwojia_n['woaiwojia_Dates_newData']

# """
# 13014 按每页30个 共有434页
# """
start_url = 'https://m.5i5j.com/sh/zufang/index-n{}'
    ...
    for page in range(134, 435):
        ...
        for i in range(0, len(houses)):
           ...
           " 朝向 ": houses[i]['_source']['heading'],
            ...
            woaiwojia_Dates_newData.insert_one(data)
            print(data)
